...
from utils import get_seed, load_data, merge_data, data_and_labels_from_indices, DATA_PATH
...
for train_and_validation_data_indices, test_data_indices in kfold_first.split(all_data, all_labels):
    ...
    # Train the model.
    hyperparameter_tuning(model_name, test_number, train_and_validation_data, train_and_validation_labels, kfold_second, EPOCHS, factor_NSA, mask_value = masking_value)